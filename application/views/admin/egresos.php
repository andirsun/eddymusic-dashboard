<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
	<li class="nav-item">
		<a class="nav-link active" id="tabIngresos" data-toggle="pill" href="#egresoEfectivo" role="tab"
			aria-controls="pills-home" aria-selected="true">Efectivo</a>
	</li>
	<li class="nav-item">
		<a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#egresoBancos" role="tab"
			aria-controls="pills-profile" aria-selected="false">Bancos</a>
	</li>
</ul>
<div class="tab-content" id="pills-tabContent">
	<div class="tab-pane fade show active" id="egresoEfectivo" role="tabpanel" aria-labelledby="pills-home-tab">
		<button type="button" class="btn btn-danger mb-2" data-toggle="modal" data-target="#modalEgresoEfectivo"
			data-whatever="@mdo">Agregar Nuevo Egreso</button>
		<!-- Container para poner el flujo de caja -->
		<div id="flujoCaja" class="container-fluid"></div>
		...
		<table class="table table-borderless table-hover table-responsive-sm ml-2 mt-2 mr-2 shadow p-3 mb-5 bg-white rounded" id="tablaEgresosEfectivo">
			<thead>
				<tr>
			...
			<tbody>
				<tr id="trClone">
					...
					<td class="d-inline-flex">
						...
						<button type="button" id="borrarEgresoEfectivo" class="btn ml-4" value=''>
	...
	<div class="tab-pane fade" id="egresoBancos" role="tabpanel" aria-labelledby="pills-profile-tab">
		<button 
			...
			data-toggle="modal"
			data-target="#modalEgresoBancos"
			data-whatever="@mdo">
			Agregar
		</button>
		<!-- COntainer para agregar el flujo de caja del banco -->
		<div id="flujoCajaBanco" class="container-fluid"></div>
		...
		<table class="table table-borderless table-hover table-responsive-sm ml-2 mt-2 mr-2 shadow p-3 mb-5 bg-white rounded" id="tablaEgresosBanco">
			<thead>
				<tr>
					<th id="fecha">Fecha</th>
			...
			<tbody>
				<tr id="trClone1">
					...
					<td id="valor"></td>
					<td class="d-inline-flex">
						<!-- If the user has the admin permissions -->
						<?php if ($level==0 /*|| $level==4*/): ?>
						<button type="button" id="borrarEgresoBanco" class="btn ml-4" value=''>
							<i class="fas fa-trash" style="color :#F65258"></i>
							Eliminar
						</button>
						<?php endif ?>
...
<div class="modal fade" id="modalEgresoEfectivo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
	aria-hidden="true">
			...
			<div class="modal-body">
				<form id="formEgresoEfectivo">
					<div class="form-group">
						<label for="recipient-name" class="col-form-label">Valor Egreso: <span
								id="valEgresoFormated">0</span></label>
...
<div class="modal fade" id="modalEgresoBancos" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
	aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
			...
			<div class="modal-body">
				<form id="formEgresoBanco">
					<div class="form-group">
						<label for="recipient-name" class="col-form-label">Valor Egreso: <span
								id="valEgresoFormated2">0</span></label>
