						...
						<div class="col-sm-10">
							<div class="btn-toolbar mb-3" role="toolbar" aria-label="Toolbar with button groups">
								...
								<div class="btn-group" role="group" aria-label="First group">
									<button type="button" class="btn btn-secondary active" data-type="1"
										id="typeDocument">C.C.</button>
								</div>
								<div class="input-group col-8">
									<input type="text" class="form-control" name="document" id="numIdentidicacion"
										placeholder="Numero identificacion" aria-label="Input group example"
...
<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content p-2">
			<h2>Hoja de vida</h2>
			<iframe src="" id="iframe-pdf" class="mb-2" style="display:none;width:100%;height:400pt;"
