	...
	<div class="card" style="overflow: unset;" card id="cardClone">
    	<div class="card-header">
      	<h2 class="mb-0 inline-block">
        		<button class="btn text-dark btn-outline-light" type="button" id="btnHeadClass" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
        		</button>
				...
				<span class="float-right">
					<?php if ($level==0 || $level==4): ?>
						<button type="button" id="botonBorrarClase" value="" class="btn btn-outline-danger mr-2">Borrar-Admin</button>
					<?php endif ?>
				</span>
   		</h2>
    	</div>
  	...
  	<table>
  		<tr id="trStudentClone">
            ...
            <form id="formSendStateStudent" class="d-flex">
              ...
              <select name="time" class="form-control" required>
                <?php for ($i = 8; $i<=19; $i++): ?>
                  <option value="<?echo $i<10? "0".$i : $i ?>:00"><?echo $i<10? "0".$i : $i ?>:00</option>
                <?php endfor ?>
              </select>
              ...
              <div class="alert my-1" id="msg-new-date" style="display: none;">
                <p class="m-0" id="text-msg"></p>
         		...
         		<span id="msg-status" style="display: none;"><i class="fa fa-spin fa-spinner"></i> Asignando...</span>
         	</fieldset>	
  			</td>
  			<td class="align-top text-center">
          <form class="d-block" id="selectTeacher">
            ...
            <div class="d-flex">
              <fieldset class="form-group d-flex m-0">                        
                <select class="custom-select" name="idTeacher" required id="list-professors" style="min-width: 19rem;">
                </select>
              </fieldset>
  		...
  		<tr id="trStudentCloneLoader">
  			<td colspan="5" class="text-center p-0"><h2 class="m-0 alert"><i class="fa fa-spin fa-spinner"></i>Cargando</h2></td>
  		</tr>
