<ul class="nav nav-pills mb-3 px-3 pt-2" id="pills-tab" role="tablist">
	<li class="nav-item">
		<a class="nav-link " id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home"
			aria-selected="true">Nuev Estudiante</a>
	</li>
	<li class="nav-item">
		<a class="nav-link active" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab"
			aria-controls="pills-profile" aria-selected="false">Estudiantes</a>
	</li>
</ul>
<div class="tab-content" id="pills-tabContent">
		...
		<div class="shadow p-3 mb-5 bg-white rounded ">
			...
			<form id="addUserForm">
					...
					<div class="col-sm-10">
						<div class="btn-toolbar mb-3" role="toolbar" aria-label="Toolbar with button groups">
							...
							<div class="input-group col-8">
								<input type="number" required class="form-control" name="document" id="numIdentidicacion"
									placeholder="Numero identificacion" aria-label="Input group example" aria-describedby="btnGroupAddon">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="form-group row no-gutters">
					...
					<div class="col-sm-10">
						<input type="number" class="form-control" name="numeroInscripcion" id="NumeroInscripcion"
							placeholder="Numero">
					</div>
				</div>
				<div class="form-group row no-gutters">
				...
				<div class="form-group row no-gutters">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="nombreAcudiente" id="nombreAcudiente"
	...
	<!-- ------------------------------------------------------------------>
	<div class="tab-pane fade show active ml-2 mr-2" id="pills-profile" role="tabpanel"
