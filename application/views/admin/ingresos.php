<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
	<li class="nav-item">
		<a class="nav-link active" id="tabIngresos" data-toggle="pill" href="#ingresosEfectivo" role="tab"
			aria-controls="pills-home" aria-selected="true">Efectivo</a>
	</li>
	<li class="nav-item">
		<a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#ingresosBancos" role="tab"
...
<div class="tab-content" id="pills-tabContent">
	<div class="tab-pane fade show active" id="ingresosEfectivo" role="tabpanel" aria-labelledby="pills-home-tab">
		<button type="button" class="btn btn-success mb-2" data-toggle="modal" data-target="#modalIngresoEfectivo"
			data-whatever="@mdo">Agregar Nuevo Ingreso</button>
		...
		<table
			class="table table-borderless table-hover table-responsive-sm ml-2 mt-2 mr-2 shadow p-3 mb-5 bg-white rounded"
			id="tablaIngresosEfectivo">
			<thead>
				<tr>
			...
			<tbody>
				<tr id="trClone">
					...
					<td class="d-inline-flex">
						...
						<button type="button" id="borrarIngresoEfectivo" class="btn btn-ligth ml-4" value=''>
	...
	<div class="tab-pane fade" id="ingresosBancos" role="tabpanel" aria-labelledby="pills-profile-tab">
		<button type="button" class="btn btn-success mb-2" data-toggle="modal" data-target="#modalIngresoBanco"
			data-whatever="@mdo">Agregar Nuevo Ingreso</button>
		...
		<table
			...
			<tbody>
				<tr id="trClone1">
					...
					<td class="d-inline-flex">
						<?php if ($level==0 /*|| $level==4*/): ?>
						<button type="button" id="borrarIngresoBanco" class="btn btn-ligth ml-4" value=''>
							<i class="fas fa-trash" style="color: #F65258"></i>
							Eliminar
						</button>
						<?php endif ?>
...
<div class="modal fade" id="modalIngresoEfectivo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
	aria-hidden="true">
			...
			<div class="modal-body">
				<form id="formAddIngreso">
					<div class="form-group">
						...
						<input name="valorAddIngreso" class="form-control" type="number" id="valorAddIngreso">
						<!--El name se usa para poder hacer el submit del formulario-->
					</div>
					<div class="form-group">
...
<!-- Modal para agregar un nuevo ingreso En la pag de boostrap esta para colocar la peticion ajax y cambiar los textos con jquery-->
<div class="modal fade" id="modalIngresoBanco" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
	aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
			...
			<div class="modal-body">
				<form id="formAddIngresoBanco">
					<div class="form-group">
						<label class="col-form-label">Valor Ingreso: <span id="valAddIngresoFormated">0</span></label>
						<input name="valorAddIngresoBanco" class="form-control" type="number" id="valorAddIngresoBanco">
						<!--El name se usa para poder hacer el submit del formulario-->
					</div>
					<div class="form-group">
						<label class="col-form-label">Concepto Ingreso</label>
